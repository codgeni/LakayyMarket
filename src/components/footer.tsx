          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex gap-4 grayscale opacity-60">
                <img src="https://via.placeholder.com/80x20?text=MonCash" alt="MonCash" className="h-5" />
                <img src="https://via.placeholder.com/80x20?text=NatCash" alt="NatCash" className="h-5" />
              </div>
            </div>
          </div>
        </div>
